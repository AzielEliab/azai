...
from azai.config import LAN_RISK, LIMITATION, MODELS, MOTTO, UI_HOST, UI_PORT
        ...
        "paths": {
            ...
            "/v1/chat/completions": {
                "post": {
                    ...
                    "summary": "OpenAI-compat chat. Stream is accepted and returned as non-stream in v0.1.",
                    "requestBody": {
                        "required": True,
                        "content": {
                            "application/json": {
